...
import com.ricram.feedbackapp.dao.TokenRepository;
...
import com.ricram.feedbackapp.entity.Token;
import com.ricram.feedbackapp.entity.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(LoginUserDto loginUserDto) {
        ...
        var user = repository.findByEmail(loginUserDto.email()).orElseThrow();
        var jwtToken = jwtService.generateToken(user);
        var refreshToken = jwtService.generateRefreshToken(user);
